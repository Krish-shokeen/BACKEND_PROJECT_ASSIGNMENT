Create Post Schema, Model & APIs in Node.js with MongoDB
 Objective
In this assignment, you will practice working with Mongoose Schemas and Models in Node.js, and expose REST API endpoints for storing and retrieving posts.
